...
let answersDatabase = {};
let booksDatabase = {
    "1": ["你为什么不开花", "小兔的帽子", "森林音乐会", "彩虹桥的故事", "小松鼠的秋天"],
    "2": ["星星的旅行", "小猫钓鱼", "神奇的铅笔", "大树的秘密", "小兔子的胡萝卜"],
    "3": ["海底探险记", "山顶的风铃", "魔法书店", "影子朋友", "神秘的公园"],
    "4": ["时间的礼物", "云朵邮递员", "奇妙图书馆", "月亮的微笑", "蓝色的河流"],
    "5": ["城市与森林", "寻找宝藏", "梦想的种子", "古老的钟表", "失落的地图"],
    "6": ["未来的信", "发明家俱乐部", "失落的王国", "星际旅行笔记", "机器人的心"]
};
// 历史测评记录
let historyRecords = [];
